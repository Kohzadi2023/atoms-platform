...
// @atoms/contracts (the worker routes on it). This matrix adds the capability names and
// which agents are premium so a coverage failure reads in capability terms; a test keeps
// it from drifting from the contracts table.
